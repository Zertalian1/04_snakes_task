...
Взаимодействие программ происходит по протоколу UDP, формат сообщений описан в файле snakes.proto.
...
Для каждого запроса DiscoverMsg с нового сокета (IP:port), создаётся новая игра, если число идущих на сервере игр не превышает 1000.
