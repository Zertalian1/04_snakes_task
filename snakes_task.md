...
Но есть следующие отличия:
 ...
 - "сервер" может вести сразу несколько игр параллельно (не более 1000), игры отличаются по UUID;
...
Для каждого запроса DiscoverMsg с нового сокета (IP:port), "сервер" создаёт новую игру.
